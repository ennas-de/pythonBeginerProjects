...
Label(root, text = 'Click Any One :', font = 'arial 10 bold').place(x=40, y=200)
...
Button(root, text= 'The Photographer', font ='arial 15', bg = 'ghost white', command = madlib1).place(x=60, y=300)
Button(root, text= 'apple and apple', font ='arial 15', command = madlib3 , bg = 'ghost white').place(x=70, y=400)
Button(root, text= 'The Butterfly', font ='arial 15', command = madlib2, bg = 'ghost white').place(x=80, y=500)
